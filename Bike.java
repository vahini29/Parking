  ...
  public static double billAmount(double minu) {
   ...
   private void buildPanel() {
      ...
      messageLabel4 = new JLabel("Enter the license " +
                                " number of the BIKE: ") ;
      messageLabel5 = new JLabel("Enter the entry time of BIKE (24hrs)") ;
      messageLabel6 = new JLabel("Enter time that return time of BIKE (24hrs)") ;
   ...
   private class IssueButtonListener implements ActionListener {
      ...
      make             = new JLabel("The model of the BIKE is: " + textField1.getText() ) ;
      model            = new JLabel("The make of the BIKE is: "  + textField2.getText() ) ;
      license          = new JLabel("The license number is: "   + textField4.getText() ) ;
      parkedMinutes    = new JLabel("The BIKE is enterd at time " + textField5.getText() + " hours " ) ;
      entryTime = new JLabel("There BIKE is retuned at time " + textField6.getText() + " hours " ) ;
      ...
      if (unPaidMin> 0)  {  
         minutes = new JLabel(" The BIKE has been parked for " + unPaidMin + " hours " ) ;
